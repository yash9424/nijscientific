    ...
    <div className="bg-white">
      ...
      <section className="py-16 px-6 lg:px-8 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">Why People Choose Us?</h2>
      ...
      <section className="py-16 px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">Our Directors</h2>
          
          <div className="grid md:grid-cols-3 gap-8 justify-items-center">
            {/* Director 1 */}
            <div className="bg-white p-6 rounded-lg shadow-sm text-center w-full max-w-sm border border-gray-100">
              ...
              <h3 className="text-lg font-bold text-gray-900">Hemant Limbani</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm text-center w-full max-w-sm border border-gray-100">
              ...
              <h3 className="text-lg font-bold text-gray-900">Yash Limbani</h3>
              <p className="text-sm text-gray-500">Managing Director</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm text-center w-full max-w-sm border border-gray-100">
              ...
              <h3 className="text-lg font-bold text-gray-900">Nij Limbani</h3>
              <p className="text-sm text-gray-500">Managing Director</p>
            </div>
          </div>
        </div>
